  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="us.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="uths.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Uthsavi & Amrutha</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7975791062</h4>
		<h4 style="font-family:'typo' ">uthsavi@gmail.com</h4>
		<h4 style="font-family:'typo' ">Adichunchanagiri Institute of Technology ,CKM</h4></div></div>
		</p>
      </div>
